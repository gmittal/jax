...
# def _all_to_all_split_axis_rule(split_name, vals, *, axis_name, concat_axis, split_axis):
#   assert isinstance(axis_name, tuple)
#   x, = vals

#   split_pos = list(axis_name).index(split_name)
#   before_axes = axis_name[:split_pos]
#   after_axes = axis_name[split_pos+1:]
